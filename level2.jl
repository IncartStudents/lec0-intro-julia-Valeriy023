...
"""
struct ParamType{T<:Real}
    x::T
    y::T
end
ParamType(1,1)
ParamType(1,1.0) #ошибка
"""
...
"""
func1(a,b) = a + b
func2(a::Int,b::Float64) = a + b
func1(1,2) #output: 3
func2(1,2.0) #output: 3.0
"""
...
"""
#абстрактный тип
abstract type NewAbstractType <:Real end
NewAbstractType <: Real
#примитивный тип
...
myClass = NewClass("Hello, Git!", 54, 6.66)
typeof(myClass)
myClass.a
"""
...
"""
#abstract type AbsParentType end
#abstract type AbsChildType1 <: AbsParentType end
#abstract type AbsChildType2 <: AbsParentType end
#absFunction1(a::AbsParentType) = print(a)
#absFunction2(a::AbsChildType1) = print(a)
#absFunction1()
"""
======================================================================
2. Функции:
...
"""
function justFunction(a)
    print("Hello, $a")
end
justFunction("Valeriy")
"""
пример лямбда-функции (аннонимной функции)
"""
lambdaFunction = x -> x^2
lambdaFunction(13)
"""
...
"""
function keywordargFunction(a; kwargs)
    ###
end
"""
функции с переменным кол-вом именованных аргументов
"""
function keywordvarargFunction(a; kwargs...)
    ###
end 
"""
...
"""
function tupleFunction(a,b,(c,d,e))
    result = (c+a,d*b,e*(a+b))
    return result
end
...
vec_string = [1 2 3]
vec_column = [10,20,30]
res = vec_string*vec_column
#умножение было произведено по правилам умножения матриц, результат является суммой произведений каждого элемента вектора-строки с соответствующим элементом вектора-столбца
"""
